...
module.exports = function(api) {
  ...
  return function(options) {
    switch(options.morph) {
      ...
      default:
        ...
        if (!cssoptions.evaltrigger)
          cssoptions.evaltrigger = false;
        return __css;
    }
  };
      ...
      for(var iter=0; iter < jsDataArray.length; iter++) {
        ...
        if(jsDataArray[iter].charAt(0) == '[')
        {
          ...
          for(var iter2=0; iter2 < jsDataCur.length; iter2++) {
            ...
            importPath = makeImportString(jsDataCur[iter2]);
          ...
          importPath = makeImportString(jsDataArray[iter]);
  ...
  function makeImportString(jsData) {
    var result;
